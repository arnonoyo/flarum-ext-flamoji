(window["webpackJsonpmodule_exports"] = window["webpackJsonpmodule_exports"] || []).push([["vendors~emoji-button"],{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global, setImmediate) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmojiButton", function() { return sn; });
...
var h = function h(e, o) {
  ...
  function s(e) {
    if (r.active) {
      clearTimeout(g), c(), r.active = !1, r.paused = !1, f.deactivateTrap(t);
  ...
  function m() {
    if (r.active) return f.activateTrap(t), g = j(function () {
      k(v());
    }), n.addEventListener("focusin", h, !0), n.addEventListener("mousedown", y, {
      capture: !0,
      passive: !1
  ...
  function c() {
    if (r.active) return n.removeEventListener("focusin", h, !0), n.removeEventListener("mousedown", y, !0), n.removeEventListener("touchstart", y, !0), n.removeEventListener("click", b, !0), n.removeEventListener("keydown", p, !0), t;
  }
...
function ie(e) {
  ...
  if (m) {
    var j = B(n);
    j === k(n) && (j = z(n)), a === D && (y = R, g -= j.clientHeight - i.height, g *= s ? 1 : -1), a === V && (v = q, d -= j.clientWidth - i.width, d *= s ? 1 : -1);
  }
  ...
  return s ? Object.assign({}, p, ((h = {})[y] = l ? "0" : "", h[v] = u ? "0" : "", h.transform = (f.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + g + "px)" : "translate3d(" + d + "px, " + g + "px, 0)", h)) : Object.assign({}, p, ((o = {})[y] = l ? g + "px" : "", o[v] = u ? d + "px" : "", o.transform = "", o));
}
  ...
  function u(e, o) {
    for (var i, a, r, t, s, c, u, l, v, y, f, j, h, p = d(e, []), b = p.length; b--;) {
      for (r = !1, t = document.createDocumentFragment(), c = (s = p[b]).nodeValue, l = 0; u = n.exec(c);) {
        if ((v = u.index) !== l && t.appendChild(m(c.slice(l, v), !0)), j = g(f = u[0]), l = v + f.length, h = o.callback(j, o), j && h) {
          for (a in (y = new Image()).onerror = o.onerror, y.setAttribute("draggable", "false"), i = o.attributes(f, j)) {
            i.hasOwnProperty(a) && 0 !== a.indexOf("on") && !y.hasAttribute(a) && y.setAttribute(a, i[a]);
          }

          y.className = o.className, y.alt = f, y.src = h, r = !0, t.appendChild(y);
        }

        y || t.appendChild(m(f, !1)), y = null;
      }
...
var Ce = /["'&<>]/,
  ...
  for (r = i.index; r < n.length; r++) {
    ...
    t !== r && (a += n.substring(t, r)), t = r + 1, a += o;
  }

  return t !== r ? a + n.substring(t, r) : a;
};

var _e = "emoji-picker__emoji";
...
function Ie(e, o) {
  e.dataset.loaded || (e.dataset.custom ? function (e) {
    var o = ze("img", "emoji-picker__custom-emoji");
    e.dataset.emoji && (o.src = Ee(e.dataset.emoji), e.innerText = "", e.appendChild(o));
...
var Se = /*#__PURE__*/function () {
  ...
  var _proto = Se.prototype;

  _proto.render = function render() {
    var _this = this;

    var e = ze("div", "emoji-picker__preview");
    return this.emoji = ze("div", "emoji-picker__preview-emoji"), e.appendChild(this.emoji), this.name = ze("div", "emoji-picker__preview-name"), e.appendChild(this.name), this.events.on("showPreview", function (e) {
  ...
  _proto.showPreview = function showPreview(e) {
    var o = e.emoji;
    e.custom ? o = "<img class=\"emoji-picker__custom-emoji\" src=\"" + Ee(e.emoji) + "\">" : "twemoji" === this.options.style && (o = ke.parse(e.emoji, this.options.twemojiOptions)), this.emoji.innerHTML = o, this.name.innerHTML = Ee(e.name);
  };

  _proto.hidePreview = function hidePreview() {
...
try {
  "undefined" != typeof window && (Ne = window), "undefined" != typeof document && (Fe = document), "undefined" != typeof MutationObserver && MutationObserver, "undefined" != typeof performance && (Be = performance);
} catch (e) {}
...
var De = (Ne.navigator || {}).userAgent,
    ...
    Ve = Fe,
    He = Be,
    Ue = (qe.document, !!Ve.documentElement && !!Ve.head && "function" == typeof Ve.addEventListener && "function" == typeof Ve.createElement),
    We = (~Re.indexOf("MSIE") || Re.indexOf("Trident/"), function () {
  try {} catch (e) {
    return !1;
  }
}(), "group"),
...
Ue && ((Ve.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(Ve.readyState) || Ve.addEventListener("DOMContentLoaded", function e() {
  Ve.removeEventListener("DOMContentLoaded", e), 1, Qe.map(function (e) {
    return e();
  });
}));
...
var co = function co() {},
    go = (Ye.measurePerformance && He && He.mark && He.measure, function (e, o, n, i) {
  var a,
      r,
      t,
      s = Object.keys(e),
...
function uo(e, o) {
  ...
  "function" != typeof Ze.hooks.addPack || a ? Ze.styles[e] = Ae({}, Ze.styles[e] || {}, r) : Ze.hooks.addPack(e, r), "fas" === e && uo("fa", o);
}
...
function Eo(e) {
  var o = e.prefix,
      n = void 0 === o ? "fa" : o,
      i = e.iconName;
  if (i) return fo(zo.definitions, n, i) || fo(Ze.styles, n, i);
}
...
var _o,
  ...
  return o = e, (n = [{
    ...
    value: function value() {
      ...
      Object.keys(a).forEach(function (o) {
        e.definitions[o] = Ae({}, e.definitions[o] || {}, a[o]), uo(o, a[o]), yo();
      });
    }
  }, {
    key: "reset",
  ...
  if (e) {
    ...
    return Co(Ae({
      ...
      return xo(), Ye.autoA11y && (g ? j["aria-labelledby"] = "".concat(Ye.replacementClass, "-title-").concat(l || oo()) : (j["aria-hidden"] = "true", j.focusable = "false")), mo({
        icons: {
          main: ko(k),
          mask: s ? ko(s.icon) : {
            found: !1,
  ...
  var o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
      n = (e || {}).icon ? e : Eo(e || {}),
      i = o.mask;
  return i && (i = (i || {}).icon ? i : Eo(i || {})), _o(n, Ae({}, o, {
    mask: i
  }));
});
...
var Ko = /*#__PURE__*/function () {
  ...
  _proto2.onEmojiClick = function onEmojiClick() {
    this.emoji.variations && this.showVariants && this.options.showVariants || !this.options.showRecents || function (e, o) {
      ...
      localStorage.setItem("emojiPicker.recent", JSON.stringify([i].concat(n.filter(function (e) {
  ...
  _proto2.onEmojiHover = function onEmojiHover() {
    this.showPreview && this.events.emit("showPreview", this.emoji);
  };

  _proto2.onEmojiLeave = function onEmojiLeave() {
...
var Jo = /*#__PURE__*/function () {
  ...
  var _proto3 = Jo.prototype;

  _proto3.render = function render() {
    var _this3 = this;

    var e = ze("div", "emoji-picker__container");
    return this.emojis.forEach(function (o) {
      return e.appendChild(new Ko(o, _this3.showVariants, !0, _this3.events, _this3.options, _this3.lazy).render());
    }), e;
  };
      ...
      var v = {
        ...
        go: function go(e, o, n) {
          ...
          var a = (e = v.prepareSearch(e))[0],
              ...
              y = 0,
              f = o.length;
          if (n && n.keys) for (var j = n.scoreFn || s, h = n.keys, p = h.length, b = f - 1; b >= 0; --b) {
            ...
            k.obj = w;
            var C = j(k);
            null !== C && (C < r || (k.score = C, u < t ? (g.add(k), ++u) : (++y, C > g.peek().score && g.replaceTop(k))));
          } else if (n && n.key) {
            var E = n.key;
            ...
            for (b = f - 1; b >= 0; --b) {
              (_ = m(w = o[b], E)) && (c(_) || (_ = v.getPrepared(_)), null !== (z = d(e, _, a)) && (z.score < r || (z = {
                ...
                indexes: z.indexes,
                obj: w
              }, u < t ? (g.add(z), ++u) : (++y, z.score > g.peek().score && g.replaceTop(z)))));
            }
          } else for (b = f - 1; b >= 0; --b) {
            var _, z;

            (_ = o[b]) && (c(_) || (_ = v.getPrepared(_)), null !== (z = d(e, _, a)) && (z.score < r || (u < t ? (g.add(z), ++u) : (++y, z.score > g.peek().score && g.replaceTop(z)))));
          }
          if (0 === u) return i;
          var O = new Array(u);
        ...
        goAsync: function goAsync(o, n, a) {
          var r = !1,
            ...
            function k() {
              ...
              var d = Date.now();
              if (a && a.keys) for (var l = a.scoreFn || s, x = a.keys, C = x.length; f >= 0; --f) {
                ...
                _.obj = E;
                var O = l(_);
                if (null !== O && !(O < j) && (_.score = O, b < h ? (y.add(_), ++b) : (++w, O > y.peek().score && y.replaceTop(_)), f % 1e3 == 0 && Date.now() - d >= 10)) return void (e ? setImmediate(k) : setTimeout(k));
              } else if (a && a.key) {
                for (var I = a.key; f >= 0; --f) {
                  if ((S = m(E = n[f], I)) && (c(S) || (S = v.getPrepared(S)), null !== (P = p(o, S, u)) && !(P.score < j) && (P = {
                    target: P.target,
                    _targetLowerCodes: null,
                    _nextBeginningIndexes: null,
                    score: P.score,
                    indexes: P.indexes,
                    obj: E
                  }, b < h ? (y.add(P), ++b) : (++w, P.score > y.peek().score && y.replaceTop(P)), f % 1e3 == 0 && Date.now() - d >= 10))) return void (e ? setImmediate(k) : setTimeout(k));
                }
              } else for (; f >= 0; --f) {
                var S, P;
                if ((S = n[f]) && (c(S) || (S = v.getPrepared(S)), null !== (P = p(o, S, u)) && !(P.score < j) && (b < h ? (y.add(P), ++b) : (++w, P.score > y.peek().score && y.replaceTop(P)), f % 1e3 == 0 && Date.now() - d >= 10))) return void (e ? setImmediate(k) : setTimeout(k));
              }
              if (0 === b) return t(i);
        ...
        algorithmNoTypo: function algorithmNoTypo(e, o, n) {
          ...
          for (g || (j *= 1e3), j -= s - t, o.score = j, o.indexes = new Array(f), p = f - 1; p >= 0; --p) {
            o.indexes[p] = y[p];
          }
...
var $o = /*#__PURE__*/function () {
  ...
  var _proto4 = $o.prototype;

  _proto4.render = function render() {
    var e = ze("div", "emoji-picker__search-not-found"),
        o = ze("div", "emoji-picker__search-not-found-icon");
    this.iconUrl ? o.appendChild(Uo(this.iconUrl)) : o.innerHTML = To, e.appendChild(o);
    var n = ze("h2");
    return n.innerHTML = Ee(this.message), e.appendChild(n), e;
  };
...
var Zo = /*#__PURE__*/function () {
  function Zo(e, o, n, i, a) {
    ...
    if (this.events = e, this.i18n = o, this.options = n, this.focusedEmojiIndex = 0, this.emojisPerRow = this.options.emojisPerRow || 8, this.emojiData = i.filter(function (e) {
      ...
      this.emojiData = [].concat(this.emojiData, _e3);
    }
  ...
  var _proto5 = Zo.prototype;

  _proto5.render = function render() {
    var _this5 = this;

    return this.searchContainer = ze("div", "emoji-picker__search-container"), this.searchField = ze("input", "emoji-picker__search"), this.searchField.placeholder = this.i18n.search, this.searchContainer.appendChild(this.searchField), this.searchIcon = ze("span", "emoji-picker__search-icon"), this.options.icons && this.options.icons.search ? this.searchIcon.appendChild(Uo(this.options.icons.search)) : this.searchIcon.innerHTML = Ro, this.searchIcon.addEventListener("click", function (e) {
  ...
  _proto5.focus = function focus() {
    this.searchField.focus();
  };

  _proto5.onClearSearch = function onClearSearch(e) {
    var _this6 = this;

    e.stopPropagation(), this.searchField.value && (this.searchField.value = "", this.resultsContainer = null, this.options.icons && this.options.icons.search ? (Oe(this.searchIcon), this.searchIcon.appendChild(Uo(this.options.icons.search))) : this.searchIcon.innerHTML = Ro, this.searchIcon.style.cursor = "default", this.events.emit("hideSearchResults"), setTimeout(function () {
      return _this6.searchField.focus();
    }));
  };

  _proto5.setFocusedEmoji = function setFocusedEmoji(e) {
    if (this.resultsContainer) {
      var _o2 = this.resultsContainer.querySelectorAll("." + _e);
  ...
  _proto5.handleResultsKeydown = function handleResultsKeydown(e) {
    if (this.resultsContainer) {
      var _o3 = this.resultsContainer.querySelectorAll("." + _e);
  ...
  _proto5.onKeyDown = function onKeyDown(e) {
    "Escape" === e.key && this.searchField.value && this.onClearSearch(e);
  };

  _proto5.onKeyUp = function onKeyUp(e) {
    var _this7 = this;
    ...
    if ("Tab" !== e.key && "Shift" !== e.key) if (this.searchField.value) {
      ...
      var _e4 = Yo.go(this.searchField.value, this.emojiData, {
        allowTypo: !0,
        limit: 100,
        key: "name"
      }).map(function (e) {
      ...
      this.events.emit("hidePreview"), _e4.length ? (this.resultsContainer = new Jo(_e4, !0, this.events, this.options, !1).render(), this.resultsContainer && (this.resultsContainer.querySelector("." + _e).tabIndex = 0, this.focusedEmojiIndex = 0, this.resultsContainer.addEventListener("keydown", function (e) {
...
var Qo = /*#__PURE__*/function () {
  ...
  var _proto6 = Qo.prototype;

  _proto6.getEmoji = function getEmoji(e) {
    return this.popup.querySelectorAll("." + _e)[e];
  };

  _proto6.setFocusedEmoji = function setFocusedEmoji(e) {
  ...
  _proto6.render = function render() {
    ...
    var e = ze("div", "emoji-picker__variant-overlay");
    e.addEventListener("click", function (e) {
      e.stopPropagation(), _this8.popup.contains(e.target) || _this8.events.emit("hideVariantPopup");
    }), this.popup.appendChild(new Ko(this.emoji, !1, !1, this.events, this.options, !1).render()), (this.emoji.variations || []).forEach(function (e, o) {
      return _this8.popup.appendChild(new Ko({
        name: _this8.emoji.name,
        emoji: e,
        key: _this8.emoji.name + o
      }, !1, !1, _this8.events, _this8.options, !1).render());
    });
    var o = this.popup.querySelector("." + _e);
    return this.focusedEmojiIndex = 0, o.tabIndex = 0, setTimeout(function () {
      return o.focus();
    }), this.popup.addEventListener("keydown", function (e) {
      "ArrowRight" === e.key ? _this8.setFocusedEmoji(Math.min(_this8.focusedEmojiIndex + 1, _this8.popup.querySelectorAll("." + _e).length - 1)) : "ArrowLeft" === e.key ? _this8.setFocusedEmoji(Math.max(_this8.focusedEmojiIndex - 1, 0)) : "Escape" === e.key && (e.stopPropagation(), _this8.events.emit("hideVariantPopup"));
...
var nn = /*#__PURE__*/function () {
  ...
  var _proto7 = nn.prototype;

  _proto7.render = function render() {
    var _this9 = this;

    var e;
    var o = ze("div", "emoji-picker__category-buttons"),
        n = this.options.categories || (null === (e = this.options.emojiData) || void 0 === e ? void 0 : e.categories) || xe.categories;
    var i = this.options.showRecents ? ["recents"].concat(n) : n;
    return this.options.custom && (i = [].concat(i, ["custom"])), i.forEach(function (e) {
      var n = ze("button", "emoji-picker__category-button");
      _this9.options.icons && _this9.options.icons.categories && _this9.options.icons.categories[e] ? n.appendChild(Uo(_this9.options.icons.categories[e])) : n.innerHTML = on[e], n.tabIndex = -1, n.title = _this9.i18n.categories[e], o.appendChild(n), _this9.buttons.push(n), n.addEventListener("click", function () {
  ...
  _proto7.setActiveButton = function setActiveButton(e, o) {
    if (o === void 0) {
      o = !0;
    }
...
var an = ["recents", "smileys", "people", "animals", "food", "activities", "travel", "objects", "symbols", "flags", "custom"];
...
var rn = /*#__PURE__*/function () {
  function rn(e, o, n, i) {
    ...
    this.events = e, this.i18n = o, this.options = n, this.emojiCategories = i, this.currentCategory = 0, this.headers = [], this.focusedIndex = 0, this.handleKeyDown = function (e) {
      ...
      var n = ze("h2", "emoji-picker__category-name");
      n.innerHTML = Ee(_this10.i18n.categories[e] || en.categories[e]), _this10.emojis.appendChild(n), _this10.headers.push(n), _this10.emojis.appendChild(new Jo(o, !0, _this10.events, _this10.options, "recents" !== e).render());
    ...
    }, this.emojisPerRow = n.emojisPerRow || 8, this.categories = (null === (a = n.emojiData) || void 0 === a ? void 0 : a.categories) || n.categories || xe.categories, n.showRecents && (this.categories = ["recents"].concat(this.categories)), n.custom && (this.categories = [].concat(this.categories, ["custom"])), this.categories.sort(function (e, o) {
      return an.indexOf(e) >= 0 && an.indexOf(o) >= 0 ? an.indexOf(e) - an.indexOf(o) : an.indexOf(e) < 0 && an.indexOf(e) < 0 ? 1 : -1;
    });
  }

  var _proto8 = rn.prototype;

  _proto8.updateRecents = function updateRecents() {
    if (this.options.showRecents) {
      this.emojiCategories.recents = Wo();

      var _e6 = this.emojis.querySelector(".emoji-picker__container");

      _e6 && _e6.parentNode && _e6.parentNode.replaceChild(new Jo(this.emojiCategories.recents, !0, this.events, this.options, !1).render(), _e6);
    }
  };
  ...
  _proto8.getEmojiCount = function getEmojiCount(e) {
    return this.emojis.querySelectorAll(".emoji-picker__container")[e].querySelectorAll("." + _e).length;
  };

  _proto8.setFocusedEmoji = function setFocusedEmoji(e, o) {
    if (o === void 0) {
      o = !0;
    }
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(rn, [{
...
var sn = /*#__PURE__*/function () {
  ...
  var _proto9 = sn.prototype;

  _proto9.on = function on(e, o) {
    this.publicEvents.on(e, o);
  };

  _proto9.off = function off(e, o) {
    this.publicEvents.off(e, o);
  };

  _proto9.setStyleProperties = function setStyleProperties() {
    var _this12 = this;
  ...
  _proto9.showSearchResults = function showSearchResults(e) {
    Oe(this.pickerContent), e.classList.add("search-results"), this.pickerContent.appendChild(e);
  };

  _proto9.hideSearchResults = function hideSearchResults() {
  ...
  _proto9.emitEmoji = function emitEmoji(_ref) {
    var o = _ref.emoji,
        n = _ref.showVariants;
    return e(this, void 0, void 0, /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
      var _this13 = this;
  ...
  _proto9.emitNativeEmoji = function emitNativeEmoji(e) {
    return {
      emoji: e.emoji,
      name: e.name
    };
  ...
  _proto9.emitCustomEmoji = function emitCustomEmoji(e) {
    return {
      url: e.emoji,
      name: e.name,
      custom: !0
  ...
  _proto9.emitTwemoji = function emitTwemoji(e) {
    var _this14 = this;
  ...
  _proto9.buildSearch = function buildSearch() {
    var _this15 = this;

    var e;
    this.options.showSearch && (this.search = new Zo(this.events, this.i18n, this.options, (null === (e = this.options.emojiData) || void 0 === e ? void 0 : e.emoji) || xe.emoji, (this.options.categories || []).map(function (e) {
      return (_this15.options.emojiData || xe).categories.indexOf(e);
    })), this.pickerEl.appendChild(this.search.render()));
  };

  _proto9.buildPreview = function buildPreview() {
    this.options.showPreview && this.pickerEl.appendChild(new Se(this.events, this.options).render());
  };

  _proto9.initPlugins = function initPlugins() {
    var _this16 = this;

    if (this.options.plugins) {
      var _e8 = ze("div", "emoji-picker__plugin-container");
  ...
  _proto9.initFocusTrap = function initFocusTrap() {
  ...
  _proto9.buildPicker = function buildPicker() {
  ...
  _proto9.showVariantPopup = function showVariantPopup(e) {
    var _this17 = this;

    var o = new Qo(this.events, e, this.options).render();
  ...
  _proto9.observeForLazyLoad = function observeForLazyLoad() {
    var _this18 = this;

    this.observer = new IntersectionObserver(this.handleIntersectionChange.bind(this), {
      root: this.emojiArea.emojis
    }), this.emojiArea.emojis.querySelectorAll("." + _e).forEach(function (e) {
      _this18.shouldLazyLoad(e) && _this18.observer.observe(e);
    });
  };

  _proto9.handleIntersectionChange = function handleIntersectionChange(e) {
    var _this19 = this;
    ...
    Array.prototype.filter.call(e, function (e) {
      ...
      Ie(e, _this19.options);
    });
  };

  _proto9.shouldLazyLoad = function shouldLazyLoad(e) {
    return "twemoji" === this.options.style || "true" === e.dataset.custom;
  };

  _proto9.onDocumentClick = function onDocumentClick(e) {
    this.pickerEl.contains(e.target) || this.hidePicker();
  };

  _proto9.destroyPicker = function destroyPicker() {
  ...
  _proto9.hidePicker = function hidePicker() {
    var _this20 = this;
    ...
    this.hideInProgress = !0, this.focusTrap.deactivate(), this.pickerVisible = !1, this.overlay && (document.body.removeChild(this.overlay), this.overlay = void 0), this.emojiArea.emojis.removeEventListener("scroll", this.emojiArea.highlightCategory), this.pickerEl.classList.add("hiding"), setTimeout(function () {
      _this20.wrapper.style.display = "none", _this20.pickerEl.classList.remove("hiding"), _this20.pickerContent.firstChild !== _this20.emojiArea.container && (Oe(_this20.pickerContent), _this20.pickerContent.appendChild(_this20.emojiArea.container)), _this20.search && _this20.search.clear(), _this20.events.emit("hideVariantPopup"), _this20.hideInProgress = !1, _this20.popper && _this20.popper.destroy(), _this20.publicEvents.emit("hidden");
  ...
  _proto9.showPicker = function showPicker(e) {
    var _this21 = this;
  ...
  _proto9.determineDisplay = function determineDisplay(e) {
  ...
  _proto9.setInitialFocus = function setInitialFocus() {
  ...
  _proto9.showMobileView = function showMobileView() {
    var e = window.getComputedStyle(this.pickerEl),
        ...
        t = parseInt(e.width),
        s = i ? i / 2 - t / 2 : 0;
    this.wrapper.style.position = "fixed", this.wrapper.style.top = r + "px", this.wrapper.style.left = s + "px", this.wrapper.style.zIndex = "5000", this.overlay = ze("div", "emoji-picker__overlay"), document.body.appendChild(this.overlay);
  };

  _proto9.togglePicker = function togglePicker(e) {
    this.pickerVisible ? this.hidePicker() : this.showPicker(e);
  };

  _proto9.isPickerVisible = function isPickerVisible() {
    return this.pickerVisible;
  };

  _proto9.onDocumentKeydown = function onDocumentKeydown(e) {
    "Escape" === e.key ? this.hidePicker() : "Tab" === e.key ? this.pickerEl.classList.add("keyboard") : e.key.match(/^[\w]$/) && this.search && this.search.focus();
  };

  _proto9.setTheme = function setTheme(e) {
...
//# sourceMappingURL=vendors~emoji-button.js.map